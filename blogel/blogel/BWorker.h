...
//			strcpy(strc, s.c_str());
//			VertexT* newVert = toVertex(strc);
//			if (newVert->wid == _my_rank)
//				load_vertex(newVert);
//			else
//				delete newVert;
//			delete strc;
...
//
//        //=========================================================
//        // blocks 是 worker定义的关于  block 的集合，
//        // 每个    block 存在有一个  bid, size, 意味着vertexes里面的顶点的bid是顺序排列的
//        //-------- create blocks ----------
//        int prev = -1;
//        BlockT* block = NULL;
//        int pos;
